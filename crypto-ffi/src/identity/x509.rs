...
use crate::timestamp::KotlinInstant;
...
impl From<core_crypto::prelude::X509Identity> for X509Identity {
    fn from(i: core_crypto::prelude::X509Identity) -> Self {
        ...
        #[cfg(not(target_family = "wasm"))]
        let not_before = KotlinInstant::from_epoch_secs(i.not_before);

        #[cfg(not(target_family = "wasm"))]
        let not_after = KotlinInstant::from_epoch_secs(i.not_after);
